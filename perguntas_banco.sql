insert into pergunta(categoria_pergunta, texto_pergunta, alternativas, resposta_correta)
values (
...
-- Insertions para categoria ciências humanas
...
-- insertions para a categoria ciências da natureza
...
O radar emite ondas de rádio com frequência f_0 que são 
refletidas pela dianteira da ambulância, retornando para 
o detector com frequência f_r
. A percepção do operador do 
...
da sirene e qual é a relação entre as frequências f_r e f_0 medidas pelo radar?',
    $${
...
-- insertions para categoria matemática e suas tecnologias
